Attribute VB_Name = "BestBoost_Noise"
#If VBA7 Then
...
Sub OutputNoise_AX80()
    ...
    For cf = 0 To 16
        ...
        Sleep (1000)
        AP.Anlr.FuncFilterLP = 4 ' not weighted
        Sleep (1000)
        N_UW = AP.Anlr.FuncRdg("V")
        Sleep (1000)
        AP.Anlr.FuncFilterLP = 5 ' A-weighted
        Sleep (1000)
        N_AW = AP.Anlr.FuncRdg("V")
        
        Cells(X, y + 2).value = N_UW
        Cells(X, y + 3).value = N_AW
