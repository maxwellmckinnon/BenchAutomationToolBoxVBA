Attribute VB_Name = "Scope_TDS3054B"
Option Explicit
Option Base 0
Option Compare Text
...
Sub Scope_Save_Image_to_File(ByVal IP_Address As String, ByVal Folder As String, ByVal Imagename As String)
    
    Dim lngRetVal As Long
    Dim url As String
    Dim LocalFilename As String
    
    url = "http://" & IP_Address & "/image.png" ' Build URL string
